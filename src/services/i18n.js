...
export const I18N_STRINGS = {
  vi: {
    app_title: "Home Health Hub",
    app_subtitle: "Nền Tảng Sức Khỏe Gia Đình",
    split_view: "Xem Hai Màn Hình",
    child_view: "Giao Diện Con Cái",
    parent_view: "Giao Diện Ba Mẹ",
    ...
    afternoon: "Chiều",
    evening: "Tối",
    rx_meds: "Thuốc kê theo đơn",
    otc_meds: "Thuốc không kê đơn / Hỗ trợ",
  ...
  en: {
    ...
    child_view: "Caregiver Web Portal",
    parent_view: "Parent Mobile App",
